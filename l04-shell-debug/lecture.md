# Виртуальные машины, основы работы с командной строкой, удаленное управление, инструменты разработки: текстовые редакторы и IDE, отладка программного обеспечения
